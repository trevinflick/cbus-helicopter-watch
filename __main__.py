...
required_files = [
    ...
    ('columbus_communities.geojson', "https://opendata.columbus.gov/datasets/c4b483507f374e62bd705450e116e017_25.geojson")]
...
try:
    ...
    while True:
        ...
        if source == "ADSBX":
            ...
            from defAirplanesLive import pull_airplaneslive
            data_indexed = {}
            for icao in planes:
                plane = planes[icao]
